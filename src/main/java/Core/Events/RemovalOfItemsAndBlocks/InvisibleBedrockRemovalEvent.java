...
public class InvisibleBedrockRemovalEvent implements Listener {

  private Main plugin;

  public InvisibleBedrockRemovalEvent(Main plugin) {
    this.plugin = plugin;
    this.plugin.getServer().getPluginManager().registerEvents(this, this.plugin);
  }

  Item item = new Item(Item.INVISIBLE_BEDROCK);
  int block = Block.INVISIBLE_BEDROCK;
